...
//            if (!buttonMask) {}
            isLooping = !isLooping
            binding.repeatButtonPA.setColorFilter(if(isLooping) ContextCompat.getColor(requireContext(),
                R.color.purple
...
//        intentFilter.addAction(STOP_PLAYING)
    ...
    private fun playNewEpisode() {
        ...
        if(isLooping) binding.repeatButtonPA.setColorFilter(ContextCompat.getColor(requireContext(),
            R.color.purple
        ))
